...
<template>
	<div class="changepass">
			...
			<div class="information">
				<el-card class="box-card">
					<div class="weui-cell">
						...
						<el-col>
							<input id="input1" class="weui-input" type="number" pattern="[0-9]*" v-model="user.pwd" placeholder="请输入旧密码"></input>
						</el-col>
					</div>
					<div class="weui-cell">
						<el-col>
						...
						<el-col>
							<input id="input1" class="weui-input" pattern="[0-9]*" v-model="user.newPwd" placeholder="请输入新密码"></input>
						</el-col>
					</div>
					<div class="weui-cell">
						<el-col>
						...
						<el-col>
							<input id="input1" class="weui-input" pattern="[0-9]*" v-model="user.newPwd" placeholder="请再次输入新密码"></input>
						</el-col>
					</div>
					<div class="weui-cell">
						<el-col>
		...
		<a class="weui-btn weui-btn_disabled weui-btn_warn" @click="changeMyProfile">确认更改</a>
...
<script>
	export default {
		...
		mounted() {
			var that = this;
			that.user.userId = localStorage.getItem("userId");
			if (that.user.userId != '') {
