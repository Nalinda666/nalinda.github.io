		...
		<el-row>
			<div class="information">
				<el-card class="box-card">
					<div class="weui-cell">
						<el-col>
							<label class="weui-label">旧手机号</label>
						</el-col>
						<el-col>
							<input id="input1" class="weui-input" pattern="[0-9]*" v-model="stuIPhone" placeholder="请输入新密码"></input>
						</el-col>
					</div>
					<div class="weui-cell">
						<el-col>
						...
						<el-col>
							<input id="input1" class="weui-input" pattern="[0-9]*" v-model="newIPhone" placeholder="请再次输入新密码"></input>
						</el-col>
					</div>
					<div class="weui-cell">
						<el-col>
